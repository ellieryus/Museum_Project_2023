...
// test connection
console.log("/routes/admin/modify");
 ...
 * insert into a table
 */
router.post("/:tableName/insert", (request, response) => {
  try {
    console.log("API for admin /admin/modify/:tableName/insert");
 ...
 * delete from a table
 */
router.post("/:tableName/delete", (request, response) => {
  try {
    console.log("API for admin /admin/modify/:tableName/delete");
    var sent_data = DECRYPT(request.body.data);
 ...
 */
router.post("/:tableName/modify", (request, response) => {
  try {
    console.log("API for admin /admin/modify/:tableName/modify");
    var sent_data = DECRYPT(request.body.data);
