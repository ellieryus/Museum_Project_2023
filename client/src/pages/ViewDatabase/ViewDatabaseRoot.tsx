...
export default function ViewDatabaseRoot(){
    ...
    const MappingTableName = () => {
      return (
        <div className="database-form-container">
          <div className="--title">
            <p className="--Text --Title">View Database</p>
          </div>
              ...
              <div className="field-container">
                ...
                <div className="button-container">
                  <Button                             
                    ...
                    handleClick={() => {
                      navigate(`/employee/view-database/${Object.values(databaseData[i*2 + 0])[0]}`)
                    }}>
                  </Button>
                </div>
              </div>
              ...
              <div className="field-container">
                ...
                <div className="button-container">
                  <Button                             
                    ...
                    //directs user to sign up page
                    handleClick={() => {
                      navigate(`/employee/view-database/${Object.values(databaseData[i*2 + 1])[0]}`)
                    }}>
                  </Button>
                </div>            
              </div>
    ...
    return (
      <div className="ViewDatabaseRoot">
        {renderer}
