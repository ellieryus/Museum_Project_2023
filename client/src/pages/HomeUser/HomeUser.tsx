  ...
  return (
    ...
    >
      ...
      <div className="team">
        ...
        <p></p>
        <p className="--SmallText">Email contact: CloudXiMuseum@gmail.com</p>
        <p className="--SmallText">Address: 410 Lecture Hall</p>
        <p className="--SmallText">Phone number: 0981113873</p>
      </div>
    </div>
  );
}
